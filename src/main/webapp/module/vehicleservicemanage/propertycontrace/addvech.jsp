...
<body>
<form class="form-inline definewidth m20" action="${ctx}/vehicleservice/contrace/property/addvech" method="post">
    <table>
        <tr>
            <td>
                门店：
...
<script>
    ...
    $('.choosevehi').click(function(){
        ...
        $.ajax({
            url:"${ctx}/vehicleservice/contrace/property/dochoosevech",
            type: "post",
