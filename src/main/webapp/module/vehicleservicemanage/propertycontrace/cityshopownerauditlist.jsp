...
<body>
<form class="form-inline definewidth m20" action="${ctx}/vehicleservice/contrace/property/cityshopowner/audit" method="post">
    门店：
...
<script>
    $(function () {
        $('.pass').click(function(){
            var id = $(this).val();
            $.ajax({
                url:"${ctx}/vehicleservice/contrace/property/cityshopowner/doaudit",
                type: "post",
                data:{id:id,status:3},
