    ...
    $(function () {
        ...
        $('#save').click(function(){
            ...
            $.ajax({
                ...
                type: "post",
                data:{id:customer_id,identity_id:identity_id,customer_name:customer_name,customer_dn:customer_dn,customer_email:customer_email,customer_type:customer_type},
