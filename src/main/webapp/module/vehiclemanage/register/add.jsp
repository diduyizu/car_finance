    ...
    <form class="definewidth m20">
        <table class="table table-bordered table-hover definewidth m10">
            ...
            <tr>
                ...
                <td><input type="text" name="buy_at" id="buy_at" required="true"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="card_at" id="card_at"/></td>
            </tr>

            <tr>
                <td width="10%" class="tableleft">年审日期</td>
                <td><input type="text" name="limited_at" id="limited_at" required="true"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="strong_insurance_expire_at" id="strong_insurance_expire_at" required="true"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="business_insurance_expire_at" id="business_insurance_expire_at" required="true"/></td>
            </tr>
            <tr>
