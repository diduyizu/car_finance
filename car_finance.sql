...
--
-- Host: localhost
-- Generation Time: 2015-04-15 18:09:58
-- 服务器版本： 5.6.16
-- PHP Version: 5.5.9
...
CREATE TABLE IF NOT EXISTS `contrace_annex` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `contrace_id` int(11) NOT NULL,
  `annex_name` varchar(128) NOT NULL,
  `annex_url` varchar(128) NOT NULL,
  `create_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `create_by` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `contrace_id` (`contrace_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='合同附件表' AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `contrace_annex`
--

INSERT INTO `contrace_annex` (`id`, `contrace_id`, `annex_name`, `annex_url`, `create_at`, `create_by`) VALUES
(1, 100058, 'IMG_0017', '/files/upload/contrace/annex/100058/4a2d2c70-ee6f-4175-b3e6-198205309dc3.JPG', '2015-04-04 02:46:37', 100000),
(2, 100058, 'IMG_0017', '/files/upload/contrace/annex/100058/addca546-4850-454f-9fa2-83cf131739fd.JPG', '2015-04-04 02:49:20', 100000);
...
(3, '111', '身份证', '321281198609041875', NULL, NULL, '1111', NULL, '2015-03-23 05:47:41', 100000, '2015-03-23 05:47:41', 100000, '个人用户', '1', '', '', '1', 'IMG_0017', '/files/upload/customer/annex/3/41442ae0-f598-431a-b8f7-b92574b23a4e.JPG', 'IMG_0018', '/files/upload/customer/annex/3/5c69133a-bcc8-4d44-a5a8-007a14b0415f.JPG', NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- 表的结构 `payment_statistics`
--
...
CREATE TABLE IF NOT EXISTS `payment_statistics` (
  ...
  `actually_price` decimal(10,2) NOT NULL,
  `return_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `contrace_type` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=7 ;

--
-- 转存表中的数据 `payment_statistics`
--

INSERT INTO `payment_statistics` (`id`, `contrace_id`, `vehicle_id`, `license_plate`, `model`, `over_price`, `actually_price`, `return_at`, `contrace_type`) VALUES
(1, 100056, 10, '苏K196L0', 'VSSCJ61P', '890.00', '905.00', '2015-04-02 13:01:31', 0),
(2, 100056, 8, '苏AK1P81', '迈腾', '0.00', '705.00', '2015-04-02 13:01:31', 0),
(3, 100057, 10, '苏K196L0', 'VSSCJ61P', '15.00', '1975.00', '2015-04-02 13:05:44', 0),
(4, 100057, 8, '苏AK1P81', '迈腾', '135.00', '1575.00', '2015-04-02 13:05:44', 0),
(5, 100058, 5, '苏AK2P38', '商务车', '0.00', '50.00', '2015-04-04 01:31:12', 0),
(6, 100058, 2, '苏AK1P93', 'cc', '0.00', '950.00', '2015-04-04 01:31:12', 0);
...
(40006, '合同店长审核', 'carfinance/vehicleservice/contrace/shopowner/audit', 40000, 0, '预约单业务经理审核', 'page', NULL, 0, 0),
...
(40009, '合同财务审核', 'carfinance/vehicleservice/contrace/finance/audit', 40000, 0, '预约单财务审核', 'page', NULL, 0, 0),
(40010, '合同总经理审核', 'carfinance/vehicleservice/contrace/generalmanager/audit', 40000, 0, '合同总经理审核', 'page', NULL, 1, 0),
...
(20206, '财务', 1, '财务'),
(20207, '配驾', 1, '配驾'),
(20208, '一类门店副店长', 1, '一类门店副店长'),
(20209, '二类门店副店长', 1, '二类门店副店长'),
(20210, '三类门店副店长', 1, '三类门店副店长'),
(20211, '收银员', 1, '收银员'),
(20212, '车管员', 1, '车管员'),
(20213, '车运员', 1, '车运员');
...
(100016, 'quanguopeijia', '96E79218965EB72C92A549DD5A330112', '全国配驾', '全国陪驾', '00123100', NULL, NULL, NULL, NULL, 100000, '2015-03-16 18:03:46', 1, 1, '12321313213'),
...
CREATE TABLE IF NOT EXISTS `vehicle_contrace` (
  ...
  `regionalmanager_audit_status` int(11) DEFAULT '0' COMMENT '是否需要区域经理审核',
  `generalmanager_audit_status` int(11) DEFAULT '0' COMMENT '是否需要总经理审核',
  `general_manager_update_by` int(11) DEFAULT NULL COMMENT '总经理审核人',
  `general_manager_update_at` timestamp NULL DEFAULT NULL COMMENT '总经理审核时间',
  PRIMARY KEY (`id`),
  KEY `reserv_to_contrace_status` (`reserv_to_contrace_status`)
...
INSERT INTO `vehicle_contrace` (`id`, `contrace_no`, `customer_name`, `customer_type`, `customer_dn`, `customer_cer_type`, `customer_cer_no`, `remark`, `employee_id`, `employee_name`, `create_at`, `create_by`, `update_at`, `update_by`, `status`, `shopowner_update_by`, `shopowner_update_at`, `city_shopowner_update_by`, `city_shopowner_update_at`, `finance_update_by`, `finance_update_at`, `org_id`, `reservation_id`, `regional_manager_update_by`, `regional_manager_update_at`, `use_begin`, `use_end`, `isovertop`, `daily_price`, `daily_available_km`, `over_km_price`, `over_hour_price`, `month_price`, `month_available_km`, `pre_payment`, `monthly_day`, `deposit`, `peccancy_deposit`, `contrace_type`, `system_total_price`, `arrange_price`, `actual_price`, `late_fee`, `is_arrearage`, `arrearage_date`, `reserv_to_contrace_status`, `regionalmanager_audit_status`, `generalmanager_audit_status`, `general_manager_update_by`, `general_manager_update_at`) VALUES
(100053, 'HT20150331100053', '123', '个人用户', '15380897663', '身份证', '321281198609041875', '1', '0523100', '泰州市业务员', '2015-03-31 00:18:16', 100000, '2015-03-31 00:18:16', 0, 6, 100000, '2015-03-31 07:42:25', 0, '2015-03-31 00:18:16', 100000, '2015-03-31 07:42:51', 1, 43, 0, '2015-03-31 00:18:16', '2015-03-31 00:15:00', '2015-05-01 00:15:00', 0, '0.00', 80, 10, 5, 0, 0, '20000.00', NULL, '10000.00', '1000.00', 1, '60225.00', '60001.00', '60001.00', '0.00', 0, '2015-04-01 01:04:45', 1, 0, 0, NULL, NULL),
(100054, 'HT20150401100054', '姜寅', '个人用户', '15380897663', '身份证', '321281198609041875', '1111', '0523100', '泰州市业务员', '2015-04-01 12:19:59', 100000, '2015-04-01 12:19:59', 0, 6, 100000, '2015-04-01 12:22:43', 0, '2015-04-01 12:19:59', 100000, '2015-04-01 12:23:13', 1, 45, 0, '2015-04-01 12:19:59', '2015-03-31 17:15:00', '2015-04-01 17:15:00', 0, '0.00', 100, 20, 10, 0, 0, '20000.00', NULL, '10000.00', '1000.00', 1, '3440.00', '3000.00', '3000.00', '0.00', 0, '2015-04-01 12:24:30', 1, 0, 0, NULL, NULL),
(100055, 'HT20150401100055', '姜寅', '个人用户', '111', '身份证', '321281198609041875', '111', '0523001', '泰州店管理员', '2015-04-01 13:19:21', 100000, '2015-04-01 13:19:21', 0, 6, 100000, '2015-04-01 13:32:25', 100000, '2015-04-01 13:32:30', 100000, '2015-04-01 13:32:38', 1, 46, 100000, '2015-04-01 13:32:34', '2015-03-31 18:30:00', '2015-04-01 18:30:00', 1, '0.00', 200, 10, 5, 0, 0, '20000.00', NULL, '10000.00', '1000.00', 1, '4220.00', '4000.00', '4000.00', '0.00', 0, '2015-04-01 13:36:07', 1, 0, 0, NULL, NULL),
(100056, 'HT20150402100056', '111', '个人用户', '111', '身份证', '321281198609041875', '111', '0523100', '泰州市业务员', '2015-04-02 12:58:39', 100000, '2015-04-02 12:58:39', 0, 6, 100000, '2015-04-02 12:59:47', 0, '2015-04-02 12:58:39', 100000, '2015-04-02 13:00:05', 1, 47, 0, '2015-04-02 12:58:39', '2015-04-02 12:00:00', '2015-04-03 12:00:00', 0, '0.00', 100, 10, 5, 0, 0, '20000.00', NULL, '10000.00', '1000.00', 1, '2690.00', '2500.00', '2500.00', '0.00', 0, '2015-04-02 13:01:31', 1, 0, 0, NULL, NULL),
(100057, 'HT20150402100057', '222', '个人用户', '111', '身份证', '321281198609041875', '1', '0523100', '泰州市业务员', '2015-04-02 13:02:47', 100000, '2015-04-02 13:02:47', 0, 6, 100000, '2015-04-02 13:04:10', 0, '2015-04-02 13:02:47', 100000, '2015-04-02 13:04:17', 1, 48, 0, '2015-04-02 13:02:47', '2015-04-02 13:00:00', '2015-04-04 13:00:00', 0, '0.00', 100, 10, 5, 0, 0, '20000.00', NULL, '10000.00', '1000.00', 1, '3750.00', '3700.00', '3700.00', '0.00', 0, '2015-04-02 13:05:44', 1, 0, 0, NULL, NULL),
(100058, 'HT20150404100058', '111', '个人用户', '111', '身份证', '321281198609041875', '111', '10001111', '朱建坤', '2015-04-04 01:28:54', 100000, '2015-04-04 01:28:54', 0, 6, 100000, '2015-04-04 01:30:29', 0, '2015-04-04 01:28:54', 100000, '2015-04-04 01:30:37', 1, 49, 0, '2015-04-04 01:28:54', '2015-04-04 01:00:00', '2015-04-04 16:00:00', 0, '0.00', 100, 80, 10, 0, 0, '20000.00', NULL, '10000.00', '1000.00', 1, '1100.00', '1000.00', '1000.00', '0.00', 0, '2015-04-04 01:31:12', 1, 0, 0, NULL, NULL),
(100059, 'HT20150412100059', '111', '个人用户', '111', '身份证', '321281198609041875', '111', '0523100', '泰州市业务员', '2015-04-12 11:55:56', 100000, '2015-04-12 11:55:56', 0, 3, 0, '2015-04-12 11:55:56', 100000, '2015-04-12 13:27:04', 0, '2015-04-12 11:55:56', 1, 50, 0, '2015-04-12 11:55:56', '2015-04-12 06:00:00', '2015-04-13 06:00:00', 0, '0.00', 100, 10, 5, 0, 0, '2000.00', NULL, '1000.00', '100.00', 1, NULL, NULL, NULL, NULL, 0, '2015-04-12 11:55:56', 1, 0, 0, NULL, NULL),
(100060, 'HT20150412100060', '111', '个人用户', '111', '身份证', '321281198609041875', '1', '0523100', '泰州市业务员', '2015-04-12 13:44:11', 100000, '2015-04-12 13:44:11', 0, 4, 0, '2015-04-12 13:44:11', 100000, '2015-04-12 13:45:11', 0, '2015-04-12 13:44:11', 1, 51, 100000, '2015-04-12 13:45:21', '2015-04-11 16:00:00', '2015-04-12 16:00:00', 0, '0.00', 100, 10, 5, 0, 0, '10000.00', NULL, '1000.00', '1000.00', 1, NULL, NULL, NULL, NULL, 0, '2015-04-12 13:44:11', 1, 1, 0, NULL, NULL),
(100061, 'HT20150412100061', '111', '个人用户', '1111', '身份证', '321281198609041875', '111', '0523100', '泰州市业务员', '2015-04-12 13:46:26', 100000, '2015-04-12 13:46:26', 0, 7, 0, '2015-04-12 13:46:26', 100000, '2015-04-12 13:47:20', 0, '2015-04-12 13:46:26', 1, 52, 100000, '2015-04-12 13:47:31', '2015-04-11 16:00:00', '2015-04-12 16:00:00', 0, '0.00', 100, 10, 2, 0, 0, '10000.00', NULL, '10000.00', '1000.00', 1, NULL, NULL, NULL, NULL, 0, '2015-04-12 13:46:26', 1, 1, 1, 100000, '2015-04-12 14:00:02');
...
CREATE TABLE IF NOT EXISTS `vehicle_contrace_vehs` (
  ...
  `dispatch_status` int(11) DEFAULT '0' COMMENT '发车状态：0-未发车；1-已发车',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='合同对应车辆详细表' AUTO_INCREMENT=45 ;

--
-- 转存表中的数据 `vehicle_contrace_vehs`
--

INSERT INTO `vehicle_contrace_vehs` (`id`, `contrace_id`, `vehicle_id`, `license_plate`, `model`, `company`, `other_vehicle_km`, `isother`, `driving_user_id`, `driving_user_name`, `driving_user_license_no`, `create_by`, `create_at`, `update_by`, `update_at`, `vehicle_price`, `return_time`, `return_km`, `return_org`, `over_price`, `status`, `etc`, `etc_money`, `oil_percent`, `revert_oil_percent`, `revert_etc_money`, `daily_price`, `settlement_way`, `fixed_price`, `system_price`, `reduction_price`, `actually_price`, `dispatch_status`) VALUES
(25, 100053, 10, '苏K196L0', 'VSSCJ61P', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-03-31 06:52:45', 0, '2015-03-31 06:52:45', '27.00', '2015-05-03 17:15:00', 1111, 100020, '325.00', 1, NULL, '0.00', 0, 10, '200.00', '1000.00', '客户自理', '0.00', '31000.00', '74.67', '30925.33', 0),
(26, 100053, 9, '苏AK1P89', '速腾', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-03-31 06:54:44', 0, '2015-03-31 06:54:44', '14.98', '2015-04-28 17:15:00', 1111, 1, '0.00', 1, '有', '0.00', 0, 20, '150.00', '900.00', '客户自理', '0.00', '27900.00', '74.67', '27825.33', 0),
(27, 100053, 8, '苏AK1P81', '迈腾', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-03-31 07:31:21', 0, '2015-03-31 07:31:21', '22.00', '2015-04-30 17:15:00', 11111, 1, '0.00', 1, NULL, '0.00', 0, 10, '211.00', '800.00', '一口价', '1000.00', '1000.00', '74.66', '925.34', 0),
(28, 100054, 10, '苏K196L0', 'VSSCJ61P', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-04-01 12:21:37', 0, '2015-04-01 12:21:37', '27.00', '2015-04-01 17:15:00', 111, 1, '0.00', 1, NULL, '200.00', 10, 10, '20.00', '1000.00', '客户自理', '0.00', '1000.00', '146.67', '853.33', 0),
(29, 100054, 9, '苏AK1P89', '速腾', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-04-01 12:21:47', 0, '2015-04-01 12:21:47', '14.98', '2015-04-02 17:15:00', 111, 1, '240.00', 1, '有', '150.00', 20, 20, '20.00', '900.00', '客户自理', '0.00', '900.00', '146.67', '753.33', 0),
(30, 100054, 8, '苏AK1P81', '迈腾', NULL, 0, 0, '100016', '全国配驾', NULL, 100000, '2015-04-01 12:21:58', 100000, '2015-04-01 12:21:58', '22.00', '2015-04-03 18:30:00', 222, 1, '500.00', 1, NULL, '211.00', 10, 10, '10.00', '800.00', '客户自理', '0.00', '800.00', '146.66', '653.34', 0),
(31, 100055, 100002, '苏A342DF', '宝马', '你好', 12345, 1, '0', NULL, NULL, 100000, '2015-04-01 13:28:50', 0, '2015-04-01 13:28:50', '430000.00', '2015-04-08 16:00:00', 11111, 1, '830.00', 1, '有', '2000.00', 100, 10, '10.00', '200.00', '', '0.00', '200.00', '110.00', '90.00', 0),
(32, 100055, 100003, '11111', '11111', '11111', 11111, 1, '0', NULL, NULL, 100000, '2015-04-01 13:31:12', 0, '2015-04-01 13:31:12', '11111.00', '2015-04-11 16:00:00', 11111, 1, '1190.00', 1, '有', '11111.00', 100, 10, '10.00', '2000.00', '公司包干', '0.00', '2000.00', '110.00', '1890.00', 0),
(33, 100056, 10, '苏K196L0', 'VSSCJ61P', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-04-02 12:59:27', 0, '2015-04-02 12:59:27', '27.00', '2015-04-03 12:00:00', 300, 1, '890.00', 1, NULL, '20.00', 10, 10, '100.00', '1000.00', '客户自理', '0.00', '1000.00', '95.00', '905.00', 0),
(34, 100056, 8, '苏AK1P81', '迈腾', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-04-02 12:59:33', 0, '2015-04-02 12:59:33', '22.00', '2015-04-03 12:00:00', 300, 1, '0.00', 1, NULL, '10.00', 10, 10, '100.00', '800.00', '客户自理', '0.00', '800.00', '95.00', '705.00', 0),
(35, 100057, 10, '苏K196L0', 'VSSCJ61P', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-04-02 13:03:40', 0, '2015-04-02 13:03:40', '27.00', '2015-04-04 16:00:00', 234, 1, '15.00', 1, NULL, '100.00', 10, 10, '10.00', '1000.00', '客户自理', '0.00', '2000.00', '25.00', '1975.00', 0),
(36, 100057, 8, '苏AK1P81', '迈腾', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-04-02 13:03:52', 0, '2015-04-02 13:03:52', '22.00', '2015-04-05 16:00:00', 345, 1, '135.00', 1, NULL, '100.00', 10, 10, '10.00', '800.00', '客户自理', '0.00', '1600.00', '25.00', '1575.00', 0),
(37, 100058, 5, '苏AK2P38', '商务车', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-04-04 01:29:23', 0, '2015-04-04 01:29:23', '28.00', '2015-04-04 01:00:00', 111, 1, '0.00', 1, NULL, '0.00', 0, 10, '10.00', '100.00', '客户自理', '0.00', '100.00', '50.00', '50.00', 0),
(38, 100058, 2, '苏AK1P93', 'cc', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-04-04 01:30:14', 0, '2015-04-04 01:30:14', '20.98', '2015-04-04 14:30:00', 222, 1, '0.00', 1, NULL, '0.00', 0, 20, '20.00', '400.00', '一口价', '1000.00', '1000.00', '50.00', '950.00', 0),
(39, 100059, 10, '苏K196L0', 'VSSCJ61P', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-04-12 12:08:13', 0, '2015-04-12 12:08:13', '27.00', NULL, NULL, 0, NULL, 0, NULL, '10.00', 20, NULL, NULL, '1000.00', '客户自理', '0.00', NULL, '0.00', '0.00', 0),
(40, 100060, 9, '苏AK1P89', '速腾', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-04-12 13:44:36', 0, '2015-04-12 13:44:36', '14.98', NULL, NULL, 0, NULL, 0, '有', '20.00', 20, NULL, NULL, '900.00', '客户自理', '0.00', NULL, '0.00', '0.00', 0),
(41, 100060, 8, '苏AK1P81', '迈腾', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-04-12 13:44:38', 0, '2015-04-12 13:44:38', '22.00', NULL, NULL, 0, NULL, 0, NULL, '10.00', 10, NULL, NULL, '800.00', '客户自理', '0.00', NULL, '0.00', '0.00', 0),
(42, 100061, 7, '苏ANON59', '帕萨特', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-04-12 13:46:49', 0, '2015-04-12 13:46:49', '21.00', NULL, NULL, 0, NULL, 0, NULL, '0.00', 0, NULL, NULL, '700.00', '客户自理', '0.00', NULL, '0.00', '0.00', 0),
(43, 100061, 6, '苏AQ7C70', '商务车', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-04-12 13:46:53', 0, '2015-04-12 13:46:53', '28.00', NULL, NULL, 0, NULL, 0, NULL, '0.00', 0, NULL, NULL, '600.00', '客户自理', '0.00', NULL, '0.00', '0.00', 0),
(44, 100061, 5, '苏AK2P38', '商务车', NULL, 0, 0, '0', NULL, NULL, 100000, '2015-04-12 13:46:59', 0, '2015-04-12 13:46:59', '28.00', NULL, NULL, 0, NULL, 0, NULL, '10.00', 10, NULL, NULL, '100.00', '客户自理', '0.00', NULL, '0.00', '0.00', 0);
...
(2, '大众', 'cc', '黑色', 'LFV3A23C0E3444215', '395089', '2015-04-04 01:31:05', '', '苏AK1P93', '2014-12-25 16:00:00', '2015-12-30 16:00:00', '20.98', '20.98', '1.00', '1', '1.00', '2015-12-22 16:00:00', '1.00', '1.00', '2015-12-22 16:00:00', 222, 7500, '正常', 514, 1, '在库', 0, '', '', '', '', '', '', '', '', '', '', '2015-03-22 12:40:34', 0, 100000, '2015-03-22 12:40:34', 1, 7500, '', '0.00', '0.00', '0.00', NULL, '20.00', 20, '400.00'),
...
(5, '别克', '商务车', '灰色', 'LSGUA84W8EE071151', '142870742', '2015-04-12 13:46:59', '', '苏AK2P38', '2014-12-17 16:00:00', '2016-12-30 16:00:00', '28.00', '28.00', '1.00', '1', '1.00', '2015-12-22 16:00:00', '1.00', '1.00', '2015-12-22 16:00:00', 111, 5000, '正常', 514, 1, '出库中', 0, '', '', '', '', '', '', '', '', '', '', '2015-03-22 12:48:05', 0, 100000, '2015-03-22 12:48:05', 1, 5000, '', '0.00', '0.00', '0.00', NULL, '10.00', 10, '100.00'),
(6, '别克', '商务车', '银色', 'LSGUD84X4EE070823', '142980277', '2015-04-15 16:08:50', '', '苏AQ7C70', '2014-12-28 16:00:00', '2016-12-30 16:00:00', '28.00', '28.00', '1.00', '1', '1.00', '2016-01-10 16:00:00', '1.00', '1.00', '2016-01-10 16:00:00', 523, 5000, '正常', 514, 1, '出库中', 0, '', '', '', '', '', '', '', '', '', '', '2015-03-22 12:50:15', 0, 100000, '2015-03-22 12:50:15', 1, 5000, '', '0.00', '0.00', '0.00', NULL, NULL, 0, '600.00'),
(7, '大众', '帕萨特', '黑色', 'LSVC26A48EN212496', 'Y25664', '2015-04-15 16:08:36', '', '苏ANON59', '2015-01-20 16:00:00', '2017-01-30 16:00:00', '21.00', '21.00', '1.00', '1', '1.00', '2016-01-10 16:00:00', '1.00', '1.00', '2016-01-10 16:00:00', 500, 7500, '正常', 514, 100020, '出库中', 1, '', '', '', '', '', '', '', '', '', '', '2015-03-22 12:55:30', 0, 100000, '2015-03-22 12:55:30', 1, 7500, '', '0.00', '0.00', '0.00', NULL, NULL, 0, '700.00'),
(8, '大众', '迈腾', '金色', 'LFV3A23COE3989159', '394619', '2015-04-12 13:44:38', '', '苏AK1P81', '2014-12-15 16:00:00', '2016-12-30 16:00:00', '22.00', '22.00', '1.00', '1', '1.00', '2016-01-10 16:00:00', '1.00', '1.00', '2016-01-10 16:00:00', 345, 7500, '正常', 514, 1, '出库中', 0, '', '', '', '', '', '', '', '', '', '', '2015-03-22 12:58:36', 0, 100000, '2015-03-22 12:58:36', 1, 7500, '', '0.00', '0.00', '0.00', NULL, '10.00', 10, '800.00'),
(9, '大众', '速腾', '黑色', 'LFV2A21K9E4218402', 'N52335', '2015-04-12 13:44:36', '', '苏AK1P89', '2014-12-15 16:00:00', '2016-12-30 16:00:00', '14.98', '14.98', '1.00', '太平洋', '1.00', '2015-12-13 16:00:00', '1.00', '1.00', '2015-12-13 16:00:00', 111, 6800, '正常', 514, 1, '出库中', 0, '', '', '', '', '', '', '', '', '', '', '2015-03-31 00:40:53', 100000, 100000, '2015-03-22 13:01:33', 1, 7500, '', '0.00', '0.00', '0.00', '有', '20.00', 20, '900.00'),
(10, '西雅特', 'VSSCJ61P', '蓝色', 'VSSCJ61P3CR040094', 'CDA268124', '2015-04-15 14:17:36', '', '苏K196L0', '2013-12-16 16:00:00', '2015-12-30 16:00:00', '27.00', '27.00', '1.00', '1', '1.00', '2015-12-15 16:00:00', '1.00', '1.00', '2015-12-15 16:00:00', 234, 7500, '正常', 514, 1, '出库中', 0, '', '', '', '', '', '', '', '', '', '', '2015-03-22 13:04:16', 0, 100000, '2015-03-22 13:04:16', 1, 7500, '', '0.00', '0.00', '0.00', NULL, '10.00', 20, '1000.00');
...
CREATE TABLE IF NOT EXISTS `vehicle_reservation` (
  ...
  `contrace_type` int(11) NOT NULL DEFAULT '1' COMMENT '合同类型：1-零租；2-产权租',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='预约单' AUTO_INCREMENT=53 ;
...
(44, '姜寅', '15380897663', '2015-04-01 12:00:00', '2015-04-02 12:00:00', NULL, NULL, NULL, NULL, NULL, '泰州市业务员', '0523100', 1, 2, 100000, '2015-04-01 12:14:06', NULL, '2015-04-01 12:14:06', NULL, '2015-04-01 12:14:06', NULL, '2015-04-01 12:14:06', '1111', 1),
(45, '姜寅', '15380897663', '2015-03-31 17:15:00', '2015-04-01 17:15:00', NULL, NULL, NULL, NULL, NULL, '0523100', '泰州市业务员', 1, 1, 100000, '2015-04-01 12:19:41', NULL, '2015-04-01 12:19:41', NULL, '2015-04-01 12:19:41', NULL, '2015-04-01 12:19:41', '1111', 1),
(46, '姜寅', '111', '2015-03-31 18:30:00', '2015-04-01 18:30:00', NULL, NULL, NULL, NULL, NULL, '0523001', '泰州店管理员', 1, 1, 100000, '2015-04-01 13:19:15', NULL, '2015-04-01 13:19:15', NULL, '2015-04-01 13:19:15', NULL, '2015-04-01 13:19:15', '111', 1),
(47, '111', '111', '2015-04-02 12:00:00', '2015-04-03 12:00:00', NULL, NULL, NULL, NULL, NULL, '0523100', '泰州市业务员', 1, 1, 100000, '2015-04-02 12:58:23', NULL, '2015-04-02 12:58:23', NULL, '2015-04-02 12:58:23', NULL, '2015-04-02 12:58:23', '111', 1),
(48, '222', '111', '2015-04-02 13:00:00', '2015-04-04 13:00:00', NULL, NULL, NULL, NULL, NULL, '0523100', '泰州市业务员', 1, 1, 100000, '2015-04-02 13:02:30', NULL, '2015-04-02 13:02:30', NULL, '2015-04-02 13:02:30', NULL, '2015-04-02 13:02:30', '1', 1),
(49, '111', '111', '2015-04-04 01:00:00', '2015-04-04 16:00:00', NULL, NULL, NULL, NULL, NULL, '10001111', '朱建坤', 1, 1, 100000, '2015-04-04 01:28:49', NULL, '2015-04-04 01:28:49', NULL, '2015-04-04 01:28:49', NULL, '2015-04-04 01:28:49', '111', 1),
(50, '111', '111', '2015-04-12 06:00:00', '2015-04-13 06:00:00', NULL, NULL, NULL, NULL, NULL, '0523100', '泰州市业务员', 1, 1, 100000, '2015-04-12 11:55:38', NULL, '2015-04-12 11:55:38', NULL, '2015-04-12 11:55:38', NULL, '2015-04-12 11:55:38', '111', 1),
(51, '111', '111', '2015-04-11 16:00:00', '2015-04-12 16:00:00', NULL, NULL, NULL, NULL, NULL, '0523100', '泰州市业务员', 1, 1, 100000, '2015-04-12 13:44:06', NULL, '2015-04-12 13:44:06', NULL, '2015-04-12 13:44:06', NULL, '2015-04-12 13:44:06', '1', 1),
(52, '111', '1111', '2015-04-11 16:00:00', '2015-04-12 16:00:00', NULL, NULL, NULL, NULL, NULL, '0523100', '泰州市业务员', 1, 1, 100000, '2015-04-12 13:46:15', NULL, '2015-04-12 13:46:15', NULL, '2015-04-12 13:46:15', NULL, '2015-04-12 13:46:15', '111', 1);
...
INSERT INTO `car_finance`.`sys_roles` (`role_id`, `role_name`, `status`, `remark`) VALUES ('20002', '总经理', '1', '总经理');
UPDATE `car_finance`.`sys_roles` SET `status` = '0' WHERE `sys_roles`.`role_id` = 20100;
INSERT INTO `car_finance`.`sys_roles` (`role_id`, `role_name`, `status`, `remark`) VALUES ('20208', '一类门店副店长', '1', '一类门店副店长');
INSERT INTO `car_finance`.`sys_roles` (`role_id`, `role_name`, `status`, `remark`) VALUES ('20209', '二类门店副店长', '1', '二类门店副店长');
INSERT INTO `car_finance`.`sys_roles` (`role_id`, `role_name`, `status`, `remark`) VALUES ('20210', '三类门店副店长', '1', '三类门店副店长');
UPDATE `car_finance`.`sys_roles` SET `status` = '0' WHERE `sys_roles`.`role_id` = 20204;
INSERT INTO `car_finance`.`sys_roles` (`role_id`, `role_name`, `status`, `remark`) VALUES ('20211', '收银员', '1', '收银员'), ('20212', '车管员', '1', '车管员');
INSERT INTO `car_finance`.`sys_roles` (`role_id`, `role_name`, `status`, `remark`) VALUES ('20213', '车运员', '1', '车运员');
UPDATE `car_finance`.`sys_menu` SET `status` = '0' WHERE `sys_menu`.`menu_id` = 40006;
UPDATE `car_finance`.`sys_menu` SET `status` = '0' WHERE `sys_menu`.`menu_id` = 40009;
INSERT INTO `car_finance`.`sys_menu` (`menu_id`, `menu_name`, `menu_url`, `pid`, `level`, `menu_desc`, `type`, `css`, `status`, `home_page_id`) VALUES ('40010', '合同总经理审核', 's s s', '40000', '0', '合同总经理审核', 'page', NULL, '1', '0');
ALTER TABLE `vehicle_contrace` ADD `regionalmanager_audit_status` INT NULL DEFAULT '0' COMMENT '是否需要区域经理审核' , ADD `generalmanager_audit_status` INT NULL DEFAULT '0' COMMENT '是否需要总经理审核' ;
ALTER TABLE `vehicle_contrace` ADD `general_manager_update_by` INT NULL COMMENT '总经理审核人' , ADD `general_manager_update_at` TIMESTAMP NULL COMMENT '总经理审核时间' ;
ALTER TABLE `vehicle_contrace_vehs` ADD `dispatch_status` INT NULL DEFAULT '0' COMMENT '发车状态：0-未发车；1-已发车' ;
