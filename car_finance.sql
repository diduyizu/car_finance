...
--
-- Host: localhost
-- Generation Time: 2015-04-01 16:10:00
-- 服务器版本： 5.6.16
-- PHP Version: 5.5.9
...
(3, '姜寅', '身份证', '321281198609041875', NULL, NULL, '111', NULL, '2015-03-23 05:47:41', 100000, '2015-03-23 05:47:41', 100000, '个人用户', '1', '', '', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `vehicle_contrace_vehs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='合同对应车辆详细表' AUTO_INCREMENT=33 ;
...
(8, '大众', '迈腾', '金色', 'LFV3A23COE3989159', '394619', '2015-04-01 12:24:18', '', '苏AK1P81', '2014-12-15 16:00:00', '2016-12-30 16:00:00', '22.00', '22.00', '1.00', '1', '1.00', '2016-01-10 16:00:00', '1.00', '1.00', '2016-01-10 16:00:00', 222, 7500, '正常', 514, 1, '在库', 0, '', '', '', '', '', '', '', '', '', '', '2015-03-22 12:58:36', 0, 100000, '2015-03-22 12:58:36', 1, 7500, '', '0.00', '0.00', '0.00', NULL, '10.00', 10, '800.00'),
...
(10, '西雅特', 'VSSCJ61P', '蓝色', 'VSSCJ61P3CR040094', 'CDA268124', '2015-04-01 12:23:41', '', '苏K196L0', '2013-12-16 16:00:00', '2015-12-30 16:00:00', '27.00', '27.00', '1.00', '1', '1.00', '2015-12-15 16:00:00', '1.00', '1.00', '2015-12-15 16:00:00', 111, 7500, '正常', 514, 1, '在库', 0, '', '', '', '', '', '', '', '', '', '', '2015-03-22 13:04:16', 0, 100000, '2015-03-22 13:04:16', 1, 7500, '', '0.00', '0.00', '0.00', NULL, '20.00', 10, '1000.00');
...
CREATE TABLE IF NOT EXISTS `vehicle_reservation` (
  ...
  `contrace_type` int(11) NOT NULL DEFAULT '1' COMMENT '合同类型：1-零租；2-产权租',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='预约单' AUTO_INCREMENT=47 ;
