...
--
-- Host: localhost
-- Generation Time: 2015-04-02 16:03:35
-- 服务器版本： 5.6.16
-- PHP Version: 5.5.9
...
(3, '222', '身份证', '321281198609041875', NULL, NULL, '111', NULL, '2015-03-23 05:47:41', 100000, '2015-03-23 05:47:41', 100000, '个人用户', '1', '', '', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `vehicle_contrace_vehs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='合同对应车辆详细表' AUTO_INCREMENT=37 ;
...
CREATE TABLE IF NOT EXISTS `vehicle_reservation` (
  ...
  `contrace_type` int(11) NOT NULL DEFAULT '1' COMMENT '合同类型：1-零租；2-产权租',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='预约单' AUTO_INCREMENT=49 ;
